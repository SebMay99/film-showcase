export default function AboutPage() {
  return (
    <div className="max-w-3xl mx-auto px-6 py-16">
      <div className="mb-10">
        <p className="font-mono text-[10px] tracking-[0.15em] text-film-brown uppercase mb-2">About — 01</p>
      ...
      <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="bg-white border border-film-brown/25 p-2 pb-8 relative mb-4">
            <div className="aspect-[3/4] bg-film-light flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="font-mono text-[9px] tracking-[0.1em] text-film-brown/50 uppercase">Foto aquí</p>
              </div>
            </div>
        ...
        <div className="space-y-6">
          <div>
            <p className="font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-2">Bio</p>
            <p className="font-serif text-base text-film-dark leading-relaxed">
              Fotógrafo aficionado con ojo para los momentos cotidianos y la luz natural.
              Capturo todo tipo de escenas: viajes, retratos, arquitectura urbana y naturaleza.
            </p>
          </div>

          <div>
            <p className="font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-2">Equipo</p>
            <p className="font-serif italic text-film-dark/70 text-sm leading-relaxed">
              Edita este texto con tu equipo real —<br />
              cámara, lentes, película favorita.
            </p>
          </div>

          <div>
            <p className="font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-3">Categorías</p>
            <div className="flex flex-wrap gap-2">
              {["Viaje", "Retrato", "Urbano", "Naturaleza"].map(tag => (
          ...
          <div className="pt-4 border-t border-film-brown/15">
            <p className="font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-2">Redes</p>
