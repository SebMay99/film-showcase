...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-6 py-16">
      <div className="mb-10">
        <p className="font-mono text-[10px] tracking-[0.15em] text-film-brown uppercase mb-2">Contacto — 03</p>
        <h1 className="font-serif text-5xl text-film-dark italic">Escríbeme</h1>
      </div>
      ...
      {sent ? (
        <div className="border border-film-brown/20 p-8 text-center rounded-sm bg-film-brown/5">
          ...
          <p className="font-serif text-xl italic text-film-dark mb-1">Mensaje enviado</p>
          <p className="font-mono text-[11px] tracking-[0.1em] text-film-brown uppercase">Te respondo pronto.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div>
              <label className="block font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-2">Nombre</label>
              <input
          ...
          <div>
            <label className="block font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-2">Mensaje</label>
            <textarea
      ...
      <div className="mt-16 pt-8 border-t border-film-brown/15">
        <p className="font-mono text-[10px] tracking-[0.12em] text-film-brown uppercase mb-3">También en</p>
        <div className="flex gap-4">
          ...
          <a href="https://github.com/SebMay99" target="_blank" rel="noopener noreferrer"
            className="font-mono text-[11px] tracking-[0.08em] text-film-brown hover:text-film-orange transition-colors underline underline-offset-3">
            GitHub →
          </a>
        </div>
